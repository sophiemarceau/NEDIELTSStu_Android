 ...
 *
 */
public class RoundProgressBarforreport extends View {
	/**
	 * 画笔对象的引用
	 */
	private Paint paint;
	...
	public RoundProgressBarforreport(Context context) {
		this(context, null);
	}

	public RoundProgressBarforreport(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}
	
	public RoundProgressBarforreport(Context context, AttributeSet attrs, int defStyle) {
