...
public class BaseDialogActivity extends Activity{
	...
	private void initview() {
		...
		System.out.println("activeClassId==="+activeClassId+"=====voteId======="+voteId);
	...
	private void ShowDiglogDevelop() {
		...
		// TODO Auto-generated method stub
		LayoutInflater layoutInflater = LayoutInflater.from(BaseDialogActivity.this);
		View myLoginView = layoutInflater.inflate(R.layout.dialog_vote_end,null);
		
		if (alertDialog == null) {
			alertDialog = new AlertDialog.Builder(BaseDialogActivity.this)
					.create();
		...
		btn_close = (ImageButton) myLoginView.findViewById(R.id.waing_end_btn_close);
		waing_end_btn_sure = (Button) myLoginView.findViewById(R.id.waing_end_btn_sure);
		...
		CalculateListviewGrideview.setListViewHeightBasedOnChildren(mdialog_listview);
		waing_end_btn_sure.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Editor ed = share.edit();
				ed.putString("voteId", null);
				ed.commit();
...
//				endvote_timer = null;
				...
				intent.setClass(context, StundentClassroom.class);
