...
public  class PinnedHeaderExpandableListView extends ExpandableListView implements OnScrollListener {
     ...
     * @param isHeaderGroupClickable ��ʾheader�Ƿ�ɵ��<br/>
     * note : ������group�ɵ����ʱ����Ҫ��OnGroupClickListener#onGroupClick�з���true��
     * ����isHeaderGroupClickable��Ϊfalse����
     */
