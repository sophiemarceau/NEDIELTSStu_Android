...
public class EditDelectText extends EditText implements OnFocusChangeListener,
		TextWatcher {
	...
	public EditDelectText(Context context) {
		this(context, null);
	}

	public EditDelectText(Context context, AttributeSet attrs) {
		this(context, attrs, android.R.attr.editTextStyle);
	}

	public EditDelectText(Context context, AttributeSet attrs, int defStyle) {
